    ...
    try {
        ...
        if (!text) {
            return await sock.sendMessage(chatId, { 
                text: "Yoo, provide an Instagram link for the video."
            });
        }
        ...
        if (!isValidUrl) {
            return await sock.sendMessage(chatId, { 
                text: "That is not a valid Instagram link. Nigga provide a valid Instagram post, reel, or video link."
            });
        }
        ...
        await sock.sendMessage(chatId, { 
            text: "❌ An error occurred while processing the Instagram request.Try again my luv."
        });
    }
}
