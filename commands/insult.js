const insults = [
    ...
    "You're a fucked up useless pu*sy.",
    ...
    try {
        ...
        if (!userToInsult) {
            await sock.sendMessage(chatId, { 
                text: 'Pu*sy, mention someone or reply to their message to insult them!'
            });
            return;
        }
        ...
        if (error.data === 429) {
            ...
            try {
                await sock.sendMessage(chatId, { 
                    text: 'Ish, an error occurred while sending the insult.'
                });
            } catch (sendError) {
