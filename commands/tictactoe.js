    ...
    try {
        ...
        if (Object.values(games).find(room => 
            ...
            await sock.sendMessage(chatId, { 
                text: '❌ You are still in a game. Type *surrender* to quit now while you can b*tch.' 
            });
            return;
        }
...
`;
        ...
        await sock.sendMessage(chatId, { 
            text: '❌ Error starting game. Try again my luv.' 
        });
    }
}
...
async function handleTicTacToeMove(sock, chatId, senderId, text) {
    try {
        ...
        if (!ok) {
            await sock.sendMessage(chatId, { 
                text: '❌ Invalid move! That position is already taken b*tch.' 
            });
            return;
        }
        ...
        if (winner) {
            ...
            gameStatus = `🤝 Game ended in a draw! GG's`;
        } else {
