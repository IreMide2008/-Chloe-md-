...
function loadUserGroupData() {
    try {
        ...
        console.error('🔥 ©️Chloe™️: Error loading user group data:', error);
        return {
            antibadword: {},
            antilink: {},
            welcome: {},
...
function saveUserGroupData(data) {
    try {
        ...
        console.error('🔥 ©️Chloe™️: Error saving user group data:', error);
        return false;
    }
}
...
async function setAntilink(groupId, type, action) {
    try {
        ...
        console.error('🔥 ©️Chloe™️: Error setting antilink:', error);
        return false;
    }
}
...
async function getAntilink(groupId, type) {
    try {
        ...
        console.error('🔥 ©️Chloe™️: Error getting antilink:', error);
        return null;
    }
}
...
async function removeAntilink(groupId, type) {
    try {
        ...
        console.error('🔥 ©️Chloe™️: Error removing antilink:', error);
        return false;
    }
}
...
async function setAntitag(groupId, type, action) {
    try {
        ...
        console.error('🔥 ©️Chloe™️: Error setting antitag:', error);
        return false;
    }
}
...
async function getAntitag(groupId, type) {
    try {
        ...
        console.error('🔥 ©️Chloe™️: Error getting antitag:', error);
        return null;
    }
}
...
async function removeAntitag(groupId, type) {
    try {
        ...
        console.error('🔥 ©️Chloe™️: Error removing antitag:', error);
        return false;
    }
}
...
async function incrementWarningCount(groupId, userId) {
    try {
        ...
        console.error('🔥 ©️Chloe™️: Error incrementing warning count:', error);
        return 0;
    }
}
...
async function resetWarningCount(groupId, userId) {
    try {
        ...
        console.error('🔥 ©️Chloe™️: Error resetting warning count:', error);
        return false;
    }
}
...
async function isSudo(userId) {
    try {
        ...
        console.error('🔥 ©️Chloe™️: Error checking sudo:', error);
        return false;
    }
}
...
async function addSudo(userJid) {
    try {
        ...
        console.error('🔥 ©️Chloe™️: Error adding sudo:', error);
        return false;
    }
}
...
async function removeSudo(userJid) {
    try {
        ...
        console.error('🔥 ©️Chloe™️: Error removing sudo:', error);
        return false;
    }
}
...
async function getSudoList() {
    try {
        ...
        console.error('🔥 ©️Chloe™️: Error getting sudo list:', error);
        return [];
    }
}
...
async function addWelcome(jid, enabled, message) {
    try {
        ...
        data.welcome[jid] = {
            enabled: enabled,
            message: message || '╔═🔥 WELCOME 🔥═╗\n║ 🛡️ User: {user}\n║ 🏰 Kingdom: {group}\n╠═══════════════╣\n║ 📜 Message:\n║ {description}\n╚═══════════════╝\n\n🔥 ©️Chloe™️: Believe it, dattebane!',
            channelId: 'https://www.whatsapp.com/channel/0029VbC27UmGOj9ronquih1M' // Updated to Chloe's channel
        };
        
        saveUserGroupData(data);
        return true;
    } catch (error) {
        console.error('🔥 ©️Chloe™️: Error in addWelcome:', error);
        return false;
    }
}
...
async function delWelcome(jid) {
    try {
        ...
        console.error('🔥 ©️Chloe™️: Error in delWelcome:', error);
        return false;
    }
}
...
async function isWelcomeOn(jid) {
    try {
        ...
        console.error('🔥 ©️Chloe™️: Error in isWelcomeOn:', error);
        return false;
    }
}
...
async function addGoodbye(jid, enabled, message) {
    try {
        ...
        console.error('🔥 ©️Chloe™️: Error in addGoodbye:', error);
        return false;
    }
}
...
async function delGoodBye(jid) {
    try {
        ...
        console.error('🔥 ©️Chloe™️: Error in delGoodBye:', error);
        return false;
    }
}
...
async function isGoodByeOn(jid) {
    try {
        ...
        console.error('🔥 ©️Chloe™️: Error in isGoodByeOn:', error);
        return false;
    }
}
...
async function getWelcome(jid) {
    try {
        ...
        console.error('🔥 ©️Chloe™️: Error in getWelcome:', error);
        return null;
    }
}
...
async function getGoodbye(jid) {
    try {
        ...
        console.error('🔥 ©️Chloe™️: Error in getGoodbye:', error);
        return null;
    }
}
...
async function setAntiBadword(groupId, type, action) {
    try {
        ...
        console.error('🔥 ©️Chloe™️: Error setting antibadword:', error);
        return false;
    }
}
...
async function getAntiBadword(groupId, type) {
    try {
        const data = loadUserGroupData();
        //console.log('🔥 ©️Chloe™️: Loading antibadword config for group:', groupId);
        //console.log('🔥 ©️Chloe™️: Current data:', data.antibadword);
        
        if (!data.antibadword || !data.antibadword[groupId]) {
            console.log('🔥 ©️Chloe™️: No antibadword config found');
            return null;
        }
        
        const config = data.antibadword[groupId];
       // console.log('🔥 ©️Chloe™️: Found config:', config);
        
        return type === 'on' ? config : null;
    } catch (error) {
        console.error('🔥 ©️Chloe™️: Error getting antibadword:', error);
        return null;
    }
}
...
async function removeAntiBadword(groupId, type) {
    try {
        ...
        console.error('🔥 ©️Chloe™️: Error removing antibadword:', error);
        return false;
    }
}
...
async function setChatbot(groupId, enabled) {
    try {
        ...
        console.error('🔥 ©️Chloe™️: Error setting chatbot:', error);
        return false;
    }
}
...
async function getChatbot(groupId) {
    try {
        ...
        console.error('🔥 ©️Chloe™️: Error getting chatbot:', error);
        return null;
    }
}
...
async function removeChatbot(groupId) {
    try {
        ...
        console.error('🔥 ©️Chloe™️: Error removing chatbot:', error);
        return false;
    }
}
