...
// List of emojis for command reactions (Kushina-themed emojis)
    ...
    try {
        if (!isOwner) {
            await sock.sendMessage(chatId, { 
                text: '🔥 This command is only available for my owner, Minato Namikaze!',
                quoted: message
            });
            return;
        }
        ...
        if (action === 'on') {
            ...
            await sock.sendMessage(chatId, { 
                text: '✅ Auto-reactions have been enabled globally, dattebane!',
                quoted: message
            });
        } else if (action === 'off') {
        ...
        await sock.sendMessage(chatId, { 
            text: '🔥 Error controlling auto-reactions, dattebane!',
            quoted: message
        });
    }
}
